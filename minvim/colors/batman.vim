" ===============================================================
" Batman (Original: OceanicNext)
" Author: Mike Hartington
" Colors: Calum Sieppert
" ===============================================================
...
" {{{ Colors
  ...
  let s:base03=['#7da2fa', '243']
  let s:base04=['#a7adba', '145']
  let s:base05=['#c0c5ce', '251']
  let s:base06=['#cdd3de', '252']
  let s:base07=['#d8dee9', '253']
  let s:base08=['#ffb200', '203']
  let s:base09=['#7da2fa', '209']
  let s:base0A=['#FFFFFF', '221']
  let s:base0B=['#888888', '114']
  let s:base0C=['#27b9b1', '73']
  let s:base0D=['#AE81FF', '68']
  let s:base0E=['#AE81FF', '176']
  let s:base0F=['#AE81FF', '137']
...
call <sid>hi('Error',                   s:none, s:none, '',          '')
...
call <sid>hi('Cursor',                     s:base09, s:base05, '',          '')
call <sid>hi('Noise',                    s:base0C, '',       '',          '')
call <sid>hi('NonText',                    s:base03, '',       '',          '')
call <sid>hi('Normal',                     s:none, s:none, '',          '')
call <sid>hi('EndOfBuffer',                s:none, s:none, '',          '')
call <sid>hi('LineNr',                     s:base03, s:none, '',          '')
...
call <sid>hi('SpellBad',               s:base08, s:base01, '',          '')
call <sid>hi('SpellCap',               s:base09, s:base01, '',          '')
...
call <sid>hi('Keyword',                    s:base08, '',       '',          '')
call <sid>hi('Label',                      s:base0A, '',       '',          '')
call <sid>hi('Number',                     s:base09, '',       '',          '')
call <sid>hi('Operator',                   s:base0D, '',       '',          '')
...
call <sid>hi('StorageClass',               s:base08, '',       '',          '')
...
call <sid>hi('jsExportDefault',           s:base08, '',       '',          '')
call <sid>hi('jsClassMethodType',           s:base08, '',       '',          '')
call <sid>hi('jsClassKeyword',           s:base08, '',       '',          '')
call <sid>hi('jsClassDefinition',           s:base0C, '',       '',          '')
call <sid>hi('jsSuper',           s:base07, '',       '',          '')
call <sid>hi('jsThis',           s:base07, '',       '',          '')
call <sid>hi('jsObjectProp',           s:base0B, '',       '',          '')
call <sid>hi('jsGlobalObjects',           s:base0C, '',       '',          '')
call <sid>hi('jsFuncBlock',           s:base0C, '',       '',          '')
call <sid>hi('jsConditional',           s:base08, '',       '',          '')
call <sid>hi('jsLabel',           s:base08, '',       '',          '')
call <sid>hi('jsObjectKey',           s:base0B, '',       '',          '')

call <sid>hi('xmlTag',                     s:base0C, '',       '',          '')
call <sid>hi('xmlTagName',                 s:base0D, '',       '',          '')
